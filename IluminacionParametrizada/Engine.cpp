...
std::string Engine::fragmentString;
std::string Engine::vertexString;
...
void keyInput(GLFWwindow *window, int key, int scancode, int action, int mods) {
	...
	if (key == GLFW_KEY_Q) {
		...
		case(GLFW_PRESS):
			...
			Engine::fragmentString = "PhongShading.f";
			Engine::vertexString = "PhongShading.v";
			break;
		case(GLFW_REPEAT):
	...
	if (key == GLFW_KEY_O) {
		...
		case(GLFW_PRESS):
			...
			//clearColorFlag = false;
			Engine::fragmentString = "passThru.f";
			Engine::vertexString = "gouradPlane.v";
			break;
		case(GLFW_REPEAT):
			//std::cout << "INPUT Q Hold\n";
			break;
